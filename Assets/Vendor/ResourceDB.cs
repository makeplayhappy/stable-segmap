...
/**
* You cant list resources using standard system.io tools - it gets compiled up into a singlefile  at build
* this creates a cache of the folder structure to use in builds
* from a unity answers - saved in the docs folder of this project
* see - /docs/docs/runtime-resources.html  [saved from https://web.archive.org/web/20220618034651/https://answers.unity.com/questions/1133078/recover-path-information-for-an-asset-but-at-runti.html?childToView=1133114]
*/
...
/*
* The scriptable Object - seems to be a sort of weird self loading singleton!
*/
...
public class ResourceDB : ScriptableObject, ISerializationCallbackReceiver
{
    ...
    void AddFileList(DirectoryInfo aFolder, int aPrefix)
    {
        ...
        foreach (var file in aFolder.GetFiles())
        {
            ...
            if( file.Name == ".DS_Store" || ext == ".ds_store"){
                continue;
            }
